...
export default {
    ...
    arena: {
        mode: 'Mode:',
        currentVsRandom: 'Current model vs Random',
        uploadVsRandom: 'Uploaded model vs Random',
        uploadVsCurrent: 'Uploaded model vs Current',
        uploadVsUpload: 'Uploaded model A vs Uploaded model B',
        modelA: 'Model A',
        modelB: 'Model B',
        games: 'Games:',
        start: 'Start Battle',
